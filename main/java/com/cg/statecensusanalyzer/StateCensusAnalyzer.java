...
class StateCensusAnalyser {
    ...
    public static <T>  int openCsvBuilder(String csvFilePath, Object myClass) throws StateCensusException {
        int counter = 0;
        try {
            ...
            throw new StateCensusException(StateCensusException.CensusExceptionType.DELIMITER_ISSUE,
                    "Error related to delimiter at record no. : " +(counter+1));
        }
        return counter;
    }

    public static Iterator<Object> getIterator(String csvFilePath, Object myClass) throws StateCensusException {
        Reader reader = null;
        ...
        try {
            ...
            throw new StateCensusException(StateCensusException.CensusExceptionType.INCORRECT_DATA_ISSUE,
                    "delimiter error at line 1 OR might be some error " +
                            "related to headers or incorrect extension / input file ");
        } catch (IOException e) {
            throw new StateCensusException(StateCensusException.CensusExceptionType.SOME_OTHER_IO_EXCEPTION,
